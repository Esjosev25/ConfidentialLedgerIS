...
namespace acl_app
{
    class Program
    {
        static async Task Main(string[] args)
        {
            ...
            const string ledgerName = "azureledgerhtis";
            ...
            Response ledgerResponse =  ledgerClient.GetLedgerEntry(transactionId, default);
            ...
            Console.WriteLine(ledgerResponse.Content);
